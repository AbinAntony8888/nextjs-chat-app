export default function Chat() {
  return (
    <div className="w-full bg-gray-300 h-full flex flex-col justify-between">
      <div className="w-full h-1/6 bg-white p-6 flex flex-row">
      ...
      <div className="p-6 overflow-y-scroll">
       <div>
        ...
        <div className="flex bg-gray-200 px-6 gap-3 items-center mb-4 ">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
          ...
          <input
            type="text"
            className="bg-gray-200 p-1 w-full outline-none rounded-md px-6"
